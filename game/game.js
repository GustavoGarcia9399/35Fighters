...
const startBell = new Audio("./game/sources/music/start_bell.mp3");
const epicMusic = new Audio("./game/sources/music/MUSICA_EPICA.mp3");
const dyingMoan = new Audio("./game/sources/music/dying_moan.mp3");
const punch = new Audio("./game/sources/music/punch.mp3");
const gravity = 1;
const backgroundMusic = new Audio("./game/sources/music/background_music.mp3");
...
const background = new Sprite({
  ...
  imageSrc: "./game/sources/img/backgrounds/background_1024x576.png",
});
const frontground = new Sprite({
  ...
  imageSrc: "./game/sources/img/backgrounds/chairs.png",
});
...
const armando = new Fighter({
  ...
  imageSrc: "./game/sources/img/players/armando/Armando_idle.png",
  framesMax: 4,
  scale: 3,
  offset: {
    x: 30,
  ...
  sprites: {
    ...
    walk: {
      imageSrc: "./game/sources/img/players/armando/Armando_walk.png",
      framesMax: 4,
    },
    punch: {
      imageSrc: "./game/sources/img/players/armando/Armando_punch.png",
      framesMax: 4,
    },
    hit: {
      imageSrc: "./game/sources/img/players/armando/Armando_hit.png",
      framesMax: 4,
    },
    death: {
      imageSrc: "./game/sources/img/players/armando/Armando_death.png",
      framesMax: 4,
    },
  },
  punchBox: {
...
const lescano = new Fighter({
  ...
  color: "blue",
  imageSrc: "./game/sources/img/players/lescano/Lescano_idle.png",
  framesMax: 4,
  scale: 3,
  offset: {
    x: 90,
  ...
  sprites: {
    ...
    walk: {
      imageSrc: "./game/sources/img/players/lescano/Lescano_walk.png",
      framesMax: 4,
    },
    punch: {
      imageSrc: "./game/sources/img/players/lescano/Lescano_punch.png",
      framesMax: 4,
    },
    hit: {
      imageSrc: "./game/sources/img/players/lescano/Lescano_hit.png",
      framesMax: 4,
    },
    death: {
      imageSrc: "./game/sources/img/players/lescano/Lescano_death.png",
      framesMax: 4,
    },
  },
  punchBox: {
